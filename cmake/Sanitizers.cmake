    ...
    if(NOT
      ...
      if(NOT MSVC)
        ...
        if (CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
          target_compile_options(${project_name} INTERFACE -fsanitize-ignorelist=${PROJECT_SOURCE_DIR}/cmake/ignorelist.txt)
          target_link_options(${project_name} INTERFACE -fsanitize-ignorelist=${PROJECT_SOURCE_DIR}/cmake/ignorelist.txt)
        endif()
      else()
